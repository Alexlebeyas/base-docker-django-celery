...
class TransMetaMixin(models.Model):

    def get_lang_field(self, field_name, language):
        return getattr(self, get_real_fieldname(field_name, language))

    def set_lang_field(self, field_name, language, value):
        setattr(self, get_real_fieldname(field_name, language), value)
